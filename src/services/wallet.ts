...
export default class Wallet extends WalletConnection {
    _connectedAccount!: CustomWalletAccount;

    account() {
        if (!this._connectedAccount) {
            this._connectedAccount = new CustomWalletAccount(
                this,
...
class CustomWalletAccount extends ConnectedWalletAccount {
