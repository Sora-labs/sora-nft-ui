                    ...
                    <li className="px-2 py-5">
                        <Link to="/" className="flex items-center gap-4">
                            <div className="flex justify-center">
                                ...
                                { home && <AiFillHome className="w-6 h-6 text-dark-gray-100 dark:text-white cursor-pointer"/> }
                            </div>
                        </Link>
                    </li>
                    <li className="px-2 py-4">
                        <Link to="/explore" className="flex items-center gap-4">
                            <div className="flex justify-center">
                               ...
                               { explore && <AiFillCompass className="w-6 h-6 text-dark-gray-100 dark:text-white cursor-pointer"/> }
                            </div>
                        </Link>
                    </li>
                    <li className="px-2 py-4">
                        <Link to="/create" className="flex items-center gap-4">
                            <div className="flex justify-center">
                                ...
                                { create && <AiFillPayCircle className="w-6 h-6 text-dark-gray-100 dark:text-white cursor-pointer"/> }
                            </div>
                        </Link>
                    </li>
                    <li className="px-2 py-4">
                        <Link to="/auction" className="flex items-center gap-4">
                            <div className="flex justify-center"> 
                                ...
                                { auction && <AiFillBank className="w-6 h-6 text-dark-gray-100 dark:text-white cursor-pointer"/> }
                            </div>
                        </Link>
                    </li>
                </ul>
            ...
            <ul className="flex flex-col">
                ...
                <li className="px-2 py-4 hover:bg-light-gray-20 dark:hover:bg-dark-gray-80">
                    <Link to="/auction" className="flex flex-col justify-center gap-2">
                        ...
                        <p className={`text-center text-xs ${auction ? 'font-bold' : ''}`}>{ t('auction') }</p>
                    </Link>
                </li>
            </ul>
        </div>
