...
const Banner = () => {
  ...
  return (
    <div
      className="flex w-full h-screen md:h-auto relative mb-24 md:px-8"
    ...
    >
      ...
      <div className="absolute inset-0 py-16">
        <div className="flex flex-col h-full px-8 font-semibold text-center items-center justify-center">
          <h2 className="text-2xl tracking-tighter uppercase font-mono text-white mb-8">
            {t("introducing")}
          </h2>
          <h1 className="text-4xl md:text-8xl text-white mb-16">
            ...
            <div className="inline-block p-2 bg-white text-transparent rounded-xl">
              <div
                className="nft-badge bg-right-top"
          ...
          <BaseButton width="w-max" rounded="rounded-full">
            {t("explore")}
          </BaseButton>
        </div>
      </div>
