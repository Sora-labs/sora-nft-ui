...
function VerifyProfileModal() {
    ...
    return (
        <div className="flex flex-col gap-4 w-3/5 p-16 shadow-md rounded-md bg-white dark:bg-transparent">
            <div className="">
            ...
            <div className="flex flex-col md:flex-row gap-4">
                <div className="w-1/2 flex justify-center items-center gap-2 py-4 px-10 bg-primary-100 rounded-lg">
