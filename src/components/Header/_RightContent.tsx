    ...
    return (
        <div className="flex flex-row items-center gap-2 md:gap-5 mr-4">
            ...
            { wallet.isSignedIn() && 
                ...
                <div className="">
                { !isOpen && <div onClick={() => dispatch(setIsOpen()) } className="w-8 h-8 md:w-10 md:h-10 p-1 bg-white rounded-full border border-light-gray-20 cursor-pointer">
                    <DefaultAvatar></DefaultAvatar>
                </div>
                }
                { isOpen && <div onClick={() => dispatch(setCloseMenu()) } className="w-8 h-8 md:w-10 md:h-10 p-1 bg-white rounded-full border border-light-gray-20 cursor-pointer">
                    <DefaultAvatar></DefaultAvatar>
                </div>
                }
                <Settings/>
