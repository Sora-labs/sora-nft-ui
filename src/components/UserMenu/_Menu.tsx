...
const Menu = () => {
  ...
  useEffect(() => {
    (async () => setBalance(await getUserBalance()))();
  }, []);
        ...
        <div className="px-4 py-3 border border-light-gray-30 rounded-md">
          <div className="">
            <div
              ...
              aria-label="balance title"
            >
              <p className="font-medium text-light-gray-45 dark:text-white">
                {t("near_balance")}
              </p>
              <p
                className="bg-light-gray-20 dark:bg-dark-gray-70 py-1 px-2 rounded-lg text-sm"
                aria-label="address"
              >
                {trimLongString(wallet.getAccountId())}
              </p>
            </div>
            <div className="text-lg font-bold">{balance ?? "0"} NEAR</div>
          </div>
          <div
            className="w-full h-px bg-light-gray-30 my-2"
          ...
          <div>
            <Link to="#" className="flex flex-row items-center justify-between">
              <div>
                ...
                <div className="text-lg font-bold">0 NEAR</div>
              </div>
              <div className="w-5 h-5">
                <AiOutlineRight className="w-full h-full text-light-gray-45 dark:text-white"></AiOutlineRight>
              </div>
