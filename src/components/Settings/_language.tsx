  ...
  return (
    <div className="">
      <div className="" aria-label="setting container">
        <div
          className="flex flex-row items-center gap-4 px-4 pb-4 border-b border-light-gray-20 dark:border-dark-gray-70"
        ...
        <div className="flex flex-col px-4">
          <div className="flex flex-col py-2">
            <div>
              <p
                className="text-xs text-light-gray-70 dark:text-dark-gray-30"
                aria-label="subtitle"
              >
              ...
              {languages.map((lang) => (
                ...
                >
                  <span style={{ minWidth: "18px" }}>
                    {localStorage["i18nextLng"] === lang.lang && (
                      <AiOutlineCheck className="text-dark-gray-35" />
                    )}
                  </span>
                  <p>{lang.name}</p>
                </div>
