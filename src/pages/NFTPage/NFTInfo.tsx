    ...
    <div className="w-full">
      ...
      <div className="w-full border-b border-light-gray-70 dark:border-dark-gray-70 py-2">
        <div className="flex justify-between">
          <div className="" aria-label="nft base info">
            <div>
              {t("minted_on")}
              <span>: 2022/06/18</span>
            </div>
          </div>
          <div className="flex items-center gap-10" aria-label="sentiment bar">
            <Reaction></Reaction>
            <Share></Share>
          </div>
        </div>
      ...
      <div className="py-8">
        <div
          ...
          aria-label="nft authority info"
        >
          <ArtistBadge
            src={getConfig(NEAR_ENV).fakeImgUrl + "50/50"}
            name="Akashic"
          ></ArtistBadge>
