...
import { isOenerProfile } from "utils/auth";
...
const ProfilePics = ({
  ...
  useEffect(() => {
    console.log(avatar, background, address);
  }, [address]);
    ...
    <div className="relative mb-8 md:mb-16">
      <div className="">
        <div className="w-full h-32 md:h-56 overflow-y-hidden">
          {profile?.avatar && (
            <img src={""} alt="not found" className="w-full object-cover" />
          )}
          {!profile?.avatar && (
